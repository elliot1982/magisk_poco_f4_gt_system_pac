...
echo 940800 >/sys/devices/system/cpu/cpufreq/policy0/scaling_max_freq
...
echo 1651200 >/sys/devices/system/cpu/cpufreq/policy7/scaling_max_freq
...
echo 0:940800 1:940800 2:940800 3:940800 4:1209600 5:1209600 6:1209600 7:1651200 >/sys/kernel/msm_performance/parameters/cpu_max_freq 
...
echo 457 >/sys/devices/system/cpu/cpu0/rq-stats/schctl 
...
echo 5 > sys/class/devfreq/3d00000.qcom,kgsl-3d0/device/kgsl/kgsl-3d0/thermal_pwrlevel

echo 0 >/sys/class/kgsl/kgsl-3d0/perfcounter
echo 710000000 >/sys/class/kgsl/kgsl-3d0/devfreq/max_freq 

echo 0 >/sys/devices/system/cpu/bus_dcvs/DDRQOS/boost_freq
